<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="quanlyteamwear.ascx.cs" Inherits="nguyeensport.admin.quanlyteamwear" %>
...
<!-- Page Heading -->
<h1 class="h3 mb-2 text-gray-800">Quản lý teamwear</h1>
<p class="mb-4">
                ...
                <div class="card-body card-body-scroll">
                   ...
                   <div class="row">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                <asp:Label ID="lblProductType" runat="server" Text="Chọn loại sản phẩm" CssClass="mb-2"></asp:Label>
                                <div class="ui-dropdownlist">
                        ...
                        <div class="col">
                            <div class="form-group">
                                <asp:Label ID="lblProductSubType" runat="server" Text="Chọn loại nhóm sản phẩm" CssClass="mb-2"></asp:Label>
                                 <div class="ui-dropdownlist">
