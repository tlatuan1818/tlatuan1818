...
{
    public partial class quanlyteamwear : System.Web.UI.UserControl
    {
        clsquanlyproduct _quanlyproduct = new clsquanlyproduct();
        clsquanlyteamwear _quanlyteamwear = new clsquanlyteamwear();
        ...
        void LoadData()
        {
            rptListProduct.DataSource = _quanlyteamwear.layTeamwear();
            ...
            if (!string.IsNullOrEmpty(txtMaSanPham.Text.Trim()))
            {
                try
                {
                    ...
                    if (hdInsert.Value.ToString() == "insert")
                    {
                        ...
                        _quanlyproduct.insertProduct(id,txtMaSanPham.Text.Trim(), txtTenSanPham.Text.Trim(), htmlEditor.Html.ToString(), float.Parse(txtGia.Text.Trim()), drDiscount.SelectedItem.ToString(), giaOutput, 3, txtTitle.Text.Trim(), txtMetaDescription.Text.Trim(), txtMetaKeywork.Text.Trim(), utf8Convert3(txtTenSanPham.Text.Trim()).ToLower().Replace(" ", "-"), image1, image2, image3, image4, image5, image6, image7, image8, image9, image10, 0, 0, DateTime.Now, hienThi, Active);
                        _quanlyteamwear.insertTeamwear(txtMaSanPham.Text.Trim(), txtProductType.Text.Trim(), txtdrSubType.Text.Trim(), drGender.SelectedItem.ToString(), txtBrands.Text.Trim(), txtCollection.Text.Trim(), txtColor.Text.Trim());
                    ...
                    else
                    {
                        ...
                        _quanlyproduct.updateProduct(txtMaSanPham.Text.Trim(), txtTenSanPham.Text.Trim(), htmlEditor.Html.ToString(), float.Parse(txtGia.Text.Trim()), drDiscount.SelectedItem.ToString(), giaOutput, 1, txtTitle.Text.Trim(), txtMetaDescription.Text.Trim(), txtMetaKeywork.Text.Trim(), utf8Convert3(txtTenSanPham.Text.Trim()).ToLower().Replace(" ", "-"), image1, image2, image3, image4, image5, image6, image7, image8, image9, image10, DateTime.Now, hienThi, Active);
        ...
        {
            DataTable dtTeamwear = new DataTable();
            dtTeamwear = _quanlyteamwear.layTeamwearTheoID(e.CommandArgument.ToString());
            switch (e.CommandName)
            {
                case "update":

                    if (dtTeamwear.Rows.Count > 0)
                    {
                        txtMaSanPham.Text = dtTeamwear.Rows[0]["maSanPham"].ToString();
                        txtTenSanPham.Text = dtTeamwear.Rows[0]["tenSanPham"].ToString();
                        txtTitle.Text = dtTeamwear.Rows[0]["titleSanPham"].ToString();
                        txtMetaDescription.Text = dtTeamwear.Rows[0]["metaDescriptionSanPham"].ToString();
                        txtMetaKeywork.Text = dtTeamwear.Rows[0]["metaKeywordsSanPham"].ToString();
                        htmlEditor.Html = dtTeamwear.Rows[0]["motaSanPham"].ToString();
                        txtGia.Text = dtTeamwear.Rows[0]["giaInput"].ToString();
                        cbkActive.Checked = ((bool)dtTeamwear.Rows[0]["Active"]) ? true : false;
                        cbkHienThi.Checked = ((bool)dtTeamwear.Rows[0]["hienThi"]) ? true : false;
                        hdImage1.Value = dtTeamwear.Rows[0]["avatarSanPham"].ToString();
                        hdImage2.Value = dtTeamwear.Rows[0]["anh1"].ToString();
                        hdImage3.Value = dtTeamwear.Rows[0]["anh2"].ToString();
                        hdImage4.Value = dtTeamwear.Rows[0]["anh3"].ToString();
                        hdImage5.Value = dtTeamwear.Rows[0]["anh4"].ToString();
                        hdImage6.Value = dtTeamwear.Rows[0]["anh5"].ToString();
                        hdImage7.Value = dtTeamwear.Rows[0]["anh6"].ToString();
                        hdImage8.Value = dtTeamwear.Rows[0]["anh7"].ToString();
                        hdImage9.Value = dtTeamwear.Rows[0]["anh8"].ToString();
                        hdImage10.Value = dtTeamwear.Rows[0]["anh9"].ToString();
                        DataTable dtProductSize = new DataTable();
                        dtProductSize = _quanlyproduct.layProductSizeTheoMaSanPham(dtTeamwear.Rows[0]["maSanPham"].ToString());
                        Session["productsize"] = dtProductSize;
                        rptListSize.DataSource = dtProductSize;
                        rptListSize.DataBind();
                        hdInsert.Value = "update";
                        hdId_FB.Value = dtTeamwear.Rows[0]["id_FB"].ToString();
                        mlv.ActiveViewIndex = 1;
                    }
                    break;
                case "delete":
                    ...
                    if (dtTeamwear.Rows.Count > 0)
                    {
                        if (dtTeamwear.Rows[0]["avatarSanPham"].ToString().Length > 0)
                        { 
                            clsThuVien.deleteImage(dtTeamwear.Rows[0]["avatarSanPham"].ToString().Substring(52).Replace(".jpg", "").Replace(".png", ""));
                        }
                        if (dtTeamwear.Rows[0]["anh1"].ToString().Length > 0)
                        {
                            clsThuVien.deleteImage(dtTeamwear.Rows[0]["anh1"].ToString().Substring(52).Replace(".jpg", "").Replace(".png", ""));
                        }
                        if (dtTeamwear.Rows[0]["anh2"].ToString().Length > 0)
                        {
                            clsThuVien.deleteImage(dtTeamwear.Rows[0]["anh2"].ToString().Substring(52).Replace(".jpg", "").Replace(".png", ""));
                        }
                        if (dtTeamwear.Rows[0]["anh3"].ToString().Length > 0)
                        {
                            clsThuVien.deleteImage(dtTeamwear.Rows[0]["anh3"].ToString().Substring(52).Replace(".jpg", "").Replace(".png", ""));
                        }
                        if (dtTeamwear.Rows[0]["anh4"].ToString().Length > 0)
                        {
                            clsThuVien.deleteImage(dtTeamwear.Rows[0]["anh4"].ToString().Substring(52).Replace(".jpg", "").Replace(".png", ""));
                        }
                        if (dtTeamwear.Rows[0]["anh5"].ToString().Length > 0)
                        {
                            clsThuVien.deleteImage(dtTeamwear.Rows[0]["anh5"].ToString().Substring(52).Replace(".jpg", "").Replace(".png", ""));
                        }
                        if (dtTeamwear.Rows[0]["anh6"].ToString().Length > 0)
                        {
                            clsThuVien.deleteImage(dtTeamwear.Rows[0]["anh6"].ToString().Substring(52).Replace(".jpg", "").Replace(".png", ""));
                        }
                        if (dtTeamwear.Rows[0]["anh7"].ToString().Length > 0)
                        {
                            clsThuVien.deleteImage(dtTeamwear.Rows[0]["anh7"].ToString().Substring(52).Replace(".jpg", "").Replace(".png", ""));
                        }
                        if (dtTeamwear.Rows[0]["anh8"].ToString().Length > 0)
                        {
                            clsThuVien.deleteImage(dtTeamwear.Rows[0]["anh8"].ToString().Substring(52).Replace(".jpg", "").Replace(".png", ""));
                        }
                        if (dtTeamwear.Rows[0]["anh9"].ToString().Length > 0)
                        {
                            clsThuVien.deleteImage(dtTeamwear.Rows[0]["anh9"].ToString().Substring(52).Replace(".jpg", "").Replace(".png", ""));
                        }
                        _quanlyproduct.deleteProductSize(dtTeamwear.Rows[0]["maSanPham"].ToString());
                        _quanlyteamwear.deleteTeamwear(dtTeamwear.Rows[0]["maSanPham"].ToString());
                        _quanlyproduct.deleteProduct(dtTeamwear.Rows[0]["maSanPham"].ToString());
                        LoadData();
                    }
                    break;
            }
