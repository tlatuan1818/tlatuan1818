<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="productsubtype.ascx.cs" Inherits="nguyeensport.admin.ortherpage.productsubtype" %>
<h1 class="h3 mb-2 text-gray-800">Quản lý loại sản phẩm con</h1>
...
<asp:MultiView ID="mlv" runat="server" ActiveViewIndex="0">
    ...
    <div class="card-header py-3">
        <asp:Button ID="btnAdd" CssClass="btn btn-outline-danger btn-sm" Text="Thêm loại sản phẩm con" runat="server" OnClick="btnAdd_Click" />
    </div>
    <div class="card-body">
        ...
        <div class="table-responsive">
            <asp:Repeater ID="rptListProduct" runat="server" OnItemDataBound="rptListProduct_ItemDataBound" OnItemCommand="rptListProduct_ItemCommand">
                ...
                <ItemTemplate>
                    <asp:HiddenField ID="maProductSubType" runat="server" Value='<%#: Eval("maProductSubType") %>' />
                     <tr>
                        <td>
                            <div class="p-2 text-secondary">
                                <%#: Eval("maProductSubType") %>
                            </div>
                        </td>
                       <td style="width:120px;">
                           <figure style="width:35px;margin-left: 45px;">
                               <img src="<%#: Eval("iconProductSubType") %>" alt="<%#: Eval("tenProductSubType") %>" />
                           </figure>
                       </td>
                       <td>
                           <div class="p-2">
                               <a class="font-weight-bold text-dark text-lg"><%#: Eval("tenProductSubType") %></a>
                           </div>
                       </td>
                           <td>
                           <div class="p-2 text-secondary">
                       ...
                       <td class="p-2" style="width:120px;"><asp:LinkButton ID="btnSua" runat="server" CommandName="update" CommandArgument='<%#: Eval("maProductSubType")%>' CssClass="text-danger"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
  <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
  <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
</svg> Sửa</asp:LinkButton> | <asp:LinkButton ID="btnXoa" runat="server" CommandName="delete" CommandArgument='<%#: Eval("maProductSubType")%>' OnClientClick="javascript:ShowProgressBar()" OnLoad="btnXoa_Load" CssClass="text-danger"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
                    ...
                    <div class="row">
                        <div class="col">
                             <div class="form-group">
                                 <asp:TextBox ID="txtTenProductSubType" CssClass="form-control" runat="server" placeholder="Tên loại sản phẩm con"></asp:TextBox>
                            </div>
                        </div>
                         <div class="col-3">
                            <div class="form-group">
                        ...
                        <div class="col-3">
                            <div class="form-group">
                                 <asp:TextBox ID="txtDanhMuc" CssClass="form-control" runat="server" placeholder="Tên danh mục"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                 <%--   <div class="row">
