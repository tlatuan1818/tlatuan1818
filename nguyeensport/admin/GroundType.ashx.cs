...
{
    /// <summary>
    /// Summary description for GroundType
    /// </summary>
    public class GroundType : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("spLayGroundTypeTheoTen", con);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add(new SqlParameter()
                {
                    ParameterName = "@tenGroundType",
                    Value = term
                });
                con.Open();
