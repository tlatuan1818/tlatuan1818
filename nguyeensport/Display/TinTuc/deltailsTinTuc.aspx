<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="deltailsTinTuc.aspx.cs" Inherits="nguyeensport.deltailsTinTuc" %>
...
<head runat="server">
    ...
    <link href="/common/css/deltailstintuc.css" rel="stylesheet" />
...
<body>
       ...
       <nav id="navigation">
        ...
        <div id="content">
            <header>
                ...
                <asp:Literal ID="ltCategori" runat="server"></asp:Literal>
            ...
            <div id="masonry-container">
                <div class="masonry-slider js-masonry-slider">
                    <div class="swiper-wrapper">
                        <asp:Literal ID="ltSlider1" runat="server"></asp:Literal>
                        <asp:Literal ID="ltSlider2" runat="server"></asp:Literal>
                        <asp:Literal ID="ltSlider3" runat="server"></asp:Literal>
                        <asp:Literal ID="ltSlider4" runat="server"></asp:Literal>
                        <asp:Literal ID="ltSlider5" runat="server"></asp:Literal>
                        <asp:Literal ID="ltSlider6" runat="server"></asp:Literal>   
                        <asp:Literal ID="ltSlider7" runat="server"></asp:Literal>
                    </div>
                ...
                <div class="masonry-box">
                    <div>
                    <asp:Literal ID="ltDanhMucTinTuc" runat="server"></asp:Literal>
                    <h1 class="masonry-title"><asp:Literal ID="ltTenTinTuc" runat="server"></asp:Literal></h1>
                    <p class="masonry-date"><asp:Literal ID="ltNgayTao" runat="server"></asp:Literal></p>
                    </div>
                </div>
                <div class="masonry-box">
                    <div class="masonry-content">
                        
                        <hr class="horizal-rule" />
                        <article>
                            <asp:Literal ID="ltContent" runat="server"></asp:Literal>
                        </article>
                        <hr class="horizal-rule" />
                    </div>
                    <div class="masonry-ads">
                        <asp:Literal ID="ltads" runat="server"></asp:Literal>
                        <div class="instagram-feed">
                            <a href="https://www.instagram.com/nguyeensport" target="_blank" >
                                 <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 31 31">
                                        <defs>
                                            <style>
                                                .cls-1 {
                            ...
                            <a href="https://www.instagram.com/nguyeensport" target="_blank">Theo dõi</a>
                        </div>
                    </div>
                </div>
                
                <div class="masonry-news-slider js-masonry-slider-4">
                    <div class="swiper-wrapper">
                         <asp:Repeater ID="rptTintuckhac" runat="server">
                            <ItemTemplate>
                                <a class="swiper-slide" href="/tin-tuc/<%#: Eval("linkNews") + "/"+ Eval("linkNewsDeltail") %>" target="_blank">
            ...
            <div class="comment-fb">
                <div class="comment-wrap">
                    ...
                    <div class="fb-comments" data-href="https://nguyeensport.com/" data-width="100%" data-numposts="5"></div>
                </div>
            </div>
            <footer>
    ...
    <script src="/common/js/edit-swiper.js"></script>
    <script type="text/javascript">
