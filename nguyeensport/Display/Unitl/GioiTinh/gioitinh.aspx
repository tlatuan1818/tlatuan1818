<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="gioitinh.aspx.cs" Inherits="nguyeensport.Display.Unitl.Men.men" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:PlaceHolder ID="loadNoiDung" runat="server"></asp:PlaceHolder>
    </div>
