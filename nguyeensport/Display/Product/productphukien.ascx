<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="productphukien.ascx.cs" Inherits="nguyeensport.Display.Product.productphukien" %>
 <div class="main">
                ...
                <div class="product_box--item">
                    ...
                    <div class="product-look_wrapper">
                        <h2 class="product-look_title">
                            <span class="product-look_title--text">Phụ kiện mới</span>
                        </h2>
